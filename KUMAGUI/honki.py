...
class MyFrame2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.distBox = wx.ComboBox(self.notebook_1_pane_1, wx.ID_ANY,
                                   choices=["1000", "500", "200", "100", "50", "20", "10", "5", "2", "1", "0.5"],
                                   style=0)
        ...
        self.phiBox = wx.ComboBox(self.notebook_1_pane_1, wx.ID_ANY, choices=["5", "10", "30", "45", "360"], style=0)
        ...
        self.label_3_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "Exposure time",
                                               style=wx.ALIGN_CENTER)
        ...
        self.label_3_copy_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "Dose", style=wx.ALIGN_CENTER)
        self.dsDoseBox = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "10.0")
        self.label_4_copy_copy_2 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "[MGy]")
        ...
        self.label_10_copy_copy_copy_copy_1 = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "Adv. length",
                                                            style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_3_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "Full flux",
                                                                 style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                                     "# of frames",
                                                                                     style=wx.ALIGN_CENTER)
        self.numFrameBox = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "", style=wx.TE_CENTRE | wx.TE_READONLY)
        self.label_11_copy_copy_4_copy_copy_copy_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                           "[frames]")
        self.label_10_copy_copy_copy_copy_3_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                      "Photons/frame", style=wx.ALIGN_CENTER)
        self.photonsPerFrameBox = wx.TextCtrl(self.notebook_1_pane_4, wx.ID_ANY, "",
        ...
        self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                                "Total exposure", style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy_copy_1 = wx.StaticText(self.notebook_1_pane_4,
                                                                                       wx.ID_ANY, "photons/deg.=",
                                                                                       style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_1_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY, "Trans. Speed.",
                                                                 style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_3_copy_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                           "Rot.Speed.", style=wx.ALIGN_CENTER)
        ...
        self.label_10_copy_copy_copy_copy_1_copy_copy = wx.StaticText(self.notebook_1_pane_4, wx.ID_ANY,
                                                                      "Ave. CountRate", style=wx.ALIGN_CENTER)
        ...
        self.notebook_1_copy = wx.Notebook(self.notebook_1_pane_4, wx.ID_ANY, style=0)
        self.notebook_1_pane_1_copy = wx.Panel(self.notebook_1_copy, wx.ID_ANY)
        self.checkbox_1 = wx.CheckBox(self.notebook_1_pane_1_copy, wx.ID_ANY, "Helical")
        ...
        self.label_4_copy_1_copy_copy_1_copy_2_copy_copy = wx.StaticText(self.notebook_1_pane_1_copy, wx.ID_ANY,
                                                                         "Suggested attenuation factor/thickness")
        self.vec1Box = wx.StaticText(self.notebook_1_pane_1_copy, wx.ID_ANY, "Start Vec.")
        ...
        self.vec1Box_copy = wx.StaticText(self.notebook_1_pane_1_copy, wx.ID_ANY, "End Vec.")
        self.vec2XBox = wx.TextCtrl(self.notebook_1_pane_1_copy, wx.ID_ANY, "0.0", style=wx.TE_CENTRE)
        self.vec2YBox = wx.TextCtrl(self.notebook_1_pane_1_copy, wx.ID_ANY, "1.2", style=wx.TE_CENTRE)
        ...
        self.dispSuitAttBox = wx.TextCtrl(self.notebook_1_pane_1_copy, wx.ID_ANY, "",
                                          style=wx.TE_CENTRE | wx.TE_READONLY)
        ...
        self.label_4_copy_1_copy_copy_1_copy_copy = wx.StaticText(self.notebook_1_pane_2_copy, wx.ID_ANY,
                                                                  "[frames/pts]")
        ...
        home_dir = os.environ['HOME']
        self.multi_dire_box = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "/isilon/users/target/target/Staff/")
        ...
        self.label_8_copy_5_copy_copy_1_copy = wx.StaticText(self.notebook_1_pane_5, wx.ID_ANY,
                                                             "Dose for data collect[MGy]\nNative: 8-10 MGy\nPhasing: 5-8 MGy",
                                                             style=wx.ALIGN_CENTER)
        ...
        self.wl_box_multi = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "1.0000",
                                        style=wx.TE_CENTRE | wx.TE_READONLY)
        ...
        self.startphi_multi = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "-5.0",
                                          style=wx.TE_CENTRE | wx.TE_READONLY)
        ...
        self.totalExpMultiBox = wx.TextCtrl(self.notebook_1_pane_5, wx.ID_ANY, "0.35",
                                            style=wx.TE_CENTRE | wx.TE_READONLY)
    ...
    def __set_properties(self):
        ...
        self.beamsizePullDown.SetForegroundColour(wx.Colour(0, 0, 0))
        self.beamsizePullDown.SetFont(wx.Font(12, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        self.beamsizePullDown.SetToolTipString("Select BeamSize")
        ...
        self.label_3_copy_copy_copy.SetMinSize((100, 18))
        ...
        self.FluxBox.SetMinSize((100, 28))
        ...
        self.label_4_copy_1_copy_copy_1_copy_2_copy_copy.SetFont(
            wx.Font(12, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, "Sans"))
        ...
        self.beamsizePullDown2.SetForegroundColour(wx.Colour(0, 0, 0))
        self.beamsizePullDown2.SetFont(wx.Font(12, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        self.beamsizePullDown2.SetToolTipString("Select BeamSize")
        ...
        self.label_8_copy_5_copy_copy_1_copy.SetToolTipString(
            "Exposure time which defines 'crystal life time' by exposure time with non-attenuated beam with your selected beam size. The value here is recommended limit from theoretical calculation of absorbed dose.")
    ...
    def __do_layout(self):
        ...
        sizer_4_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_4_copy_copy.Add((0, 0), 0, 0, 0)
        ...
        sizer_4_copy_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_4_copy_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_4_copy_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_4_copy_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_4_copy_copy_copy.Add((0, 0), 0, 0, 0)
        ...
        sizer_14.Add(self.label_3_copy_copy_copy, 0, 0, 0)
        sizer_14.Add(self.dsDoseBox, 0, 0, 0)
        sizer_14.Add(self.label_4_copy_copy_2, 0, 0, 0)
        sizer_14.Add((0, 0), 0, 0, 0)
        sizer_12_copy.Add(sizer_14, 1, wx.EXPAND, 0)
        ...
        sizer_11_copy_1_copy_1_copy_3_copy.Add(self.label_10_copy_copy_copy_copy_3_copy, 0, wx.ALIGN_CENTER_HORIZONTAL,
                                               0)
        ...
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy.Add(
            self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy_copy, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy.Add(self.numFrameBox, 0, 0, 0)
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy.Add(self.label_11_copy_copy_4_copy_copy_copy_copy_copy,
                                                                   0, 0, 0)
        sizer_10_copy_2.Add(sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy, 1, wx.EXPAND, 0)
        sizer_11_copy_1_copy_1_copy_3_copy_copy.Add(self.label_10_copy_copy_copy_copy_3_copy_copy, 0,
        ...
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy.Add(self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy,
        ...
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy_1.Add(
            self.label_10_copy_copy_copy_copy_3_copy_copy_copy_copy_copy_1, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy_1.Add(self.phsPerRotBox, 0, 0, 0)
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy_1.Add(
            self.label_11_copy_copy_4_copy_copy_copy_copy_copy_1, 0, 0, 0)
        sizer_10_copy_2_copy.Add(sizer_11_copy_1_copy_1_copy_3_copy_copy_copy_copy_copy_1, 1, wx.EXPAND, 0)
        sizer_11_copy_1_copy_1_copy_1_copy.Add(self.label_10_copy_copy_copy_copy_1_copy, 0, wx.ALIGN_CENTER_HORIZONTAL,
                                               0)
        ...
        sizer_11_copy_1_copy_1_copy_3_copy_copy_copy.Add(self.label_10_copy_copy_copy_copy_3_copy_copy_copy, 0,
                                                         wx.ALIGN_CENTER_HORIZONTAL, 0)
        ...
        sizer_11_copy_1_copy_1_copy_1_copy_copy.Add(self.label_10_copy_copy_copy_copy_1_copy_copy, 0,
                                                    wx.ALIGN_CENTER_HORIZONTAL, 0)
        ...
        sizer_7_copy_copy_1.Add((0, 0), 0, 0, 0)
        ...
        sizer_7_copy_copy_1_copy.Add((0, 0), 0, 0, 0)
        ...
        sizer_7_copy_copy_1_copy_copy.Add((0, 0), 0, 0, 0)
        ...
        sizer_7_copy_copy_1_copy_2.Add((0, 0), 0, 0, 0)
        ...
        sizer_7_copy_copy_1_copy_copy_1.Add((0, 0), 0, 0, 0)
        ...
        sizer_7_copy_copy_1_copy_copy_1_copy.Add((0, 0), 0, 0, 0)
        ...
        sizer_5_copy_copy_1.Add((0, 0), 0, 0, 0)
        sizer_3_copy_copy_1.Add(sizer_5_copy_copy_1, 0, wx.EXPAND, 0)
        self.notebook_1_pane_2_copy.SetSizer(sizer_3_copy_copy_1)
        self.notebook_1_copy.AddPage(self.notebook_1_pane_1_copy, "Helical settings")
        self.notebook_1_copy.AddPage(self.notebook_1_pane_2_copy, "_DO_NOT_USE_")
        ...
        sizer_35_copy_2_copy_copy.Add((0, 0), 0, 0, 0)
        sizer_35_copy_2_copy_copy.Add((0, 0), 0, 0, 0)
        ...
        self.notebook_1.AddPage(self.notebook_1_pane_4, "Helical/Single")
    ...
    def getFlux(self, wavelength, mode = "helical"):
        if mode == "helical":
            ...
            bs_index_for_bss = self.beamsizePullDown2.GetCurrentSelection() + 1
        beamh_um, beamv_um = self.bsconf.getBeamsizeAtIndex(bs_index_for_bss)
        print "Selected beamsize " ,bs_index_for_bss, beamh_um, beamv_um
        # Flux estimation is based on beamsize.conf
        full_flux = self.bsconf.getFluxAtWavelength(beamh_um, beamv_um, wavelength)
        print "Full flux=%e"%full_flux
        return full_flux
    ...
    def checkAdvanced(self):
        ...
        y_dist = numpy.abs(scanvec[1])
        #print "SSSS", scanvec
        crysize_um = y_dist * 1000.0
...
#        kuma = KUMA.KUMA(self.logfile)
        ...
        dist_vec_um = dist_vec * 1000.0 # [um]
        ...
        print ("KUMA: Best attenuation factor=%8.5f\n" % best_transmission)
        self.logfile.write("Reduced factor for dose slicing: %8.5f\n" % cond['reduced_fact'])
        self.logfile.write("The number of datasets to be collected: %5d\n" % cond['ntimes'])
        mod_transmission = cond['reduced_fact'] * best_transmission
        """
        crysize_mm = y_dist
        exptime, transmission = kuma.getBestCondsHelical(cond, full_flux, crysize_mm)

        self.exptimeBox.SetValue("%5.2f" % exptime)

        print exptime, transmission
        ...
        real_thick = self.attfac.calcThickness(wavelength, transmission)
        best_thick = self.attfac.getBestAtt(wavelength, transmission)
        print "Attfactor=", transmission, "Al=", best_thick

        transstr = "%5.2f" % (transmission * 100.0) + " %"
        thickstr = "%4.0f" % best_thick
        self.dispARDbox.SetValue(transstr)
        self.dispSuitAttBox.SetValue(thickstr)
        self.attSimuBox.SetValue("%5.2f" % (transmission * 100.0))
        # self.finalTransBox.SetValue("%5.2f" % transtr)

        # Simulation box
        phs_per_frame = full_flux * transmission * exptime
        flstr = "%5.2e" % phs_per_frame
        self.photonsPerFrameBox.SetValue(flstr)
        flux_per_angle = phs_per_frame / osc_step
        fpa_str = "%5.2e" % flux_per_angle
        ...
        # Optimism count rate
        # EIGER 233.2 x 245.2 mm2
        optimism_count_rate = full_flux * transmission / 423.6 / 434.6
        ocr_str = "%5.1e" % optimism_count_rate
        self.countRateBox.SetValue(ocr_str)
        if optimism_count_rate > 5E8:
            self.countRateBox.SetBackgroundColour(wx.Colour(150, 0, 0))
    ...
    def checkSingle(self):
        ...
        self.logfile.write("%s: KUMA.checkSingle is called" % datetime.datetime.now())
        ...
        bs_index_for_bss = bs_index + 1
        beamh_um, beamv_um = self.bsconf.getBeamsizeAtIndex(bs_index_for_bss)
        print bs_index, beamh_um, beamv_um
        full_flux = self.bsconf.getFluxAtWavelength(beamh_um, beamv_um, wavelength)

        # Crysta size is set to beam size (horizontal)
        crysize_um = beamh_um
        diststr = "%8.4f" % crysize_um
        self.advancedLength.SetValue(diststr)
        print "Flux=", full_flux
        ...
        # Special for BL41XU 
        transmission = self.photon_density_limit * (crysize_um * beamv_um * osc_step) / (
                full_flux * exptime * phi_total)
        real_thick = self.attfac.calcThickness(wavelength, transmission)
        best_thick = self.attfac.getBestAtt(wavelength, transmission)
        print "Attfactor=", transmission, "Al=", best_thick
    ...
    def pushCheck2D(self, event):  # wxGlade: MyFrame2.<event_handler>
        ...
        try:
            self.startlist, self.endlist, self.fastlen, self.slowlen = self.gv.yattane(origv, fastv, slowv, self.nf,
                                                                                       self.ns)
    ...
    def pushChooseDirectoryButton(self, event):  # wxGlade: MyFrame2.<event_handler>
        dialog = wx.DirDialog(None, "Choose a directory:", defaultPath=self.direBox.GetValue(),
    ...
    def genMulti(self, event):  # wxGlade: MyFrame2.<event_handler>
        ...
        startphi, endphi, best_trans = self.resetMultiCondition(conditions)
    ...
    def readMultiCondition(self):
        ...
        # set life time for each crystal
        self.FFexptimeBox.SetValue("%6.2f" % exp_lifetime)
