...
# 'dmin_start_2' is for setting lower resolution limit
dmin_start_1=3.0
dmin_start_2=5.0

# Margin to make a lower resolution limit for CC calculation 
# from the 'dmin_start_?'
cc_margin=1.5

# case
# false : only 'dmin_start_1' is used (dmin_start_2 is skipped)
do_lowreso=false
